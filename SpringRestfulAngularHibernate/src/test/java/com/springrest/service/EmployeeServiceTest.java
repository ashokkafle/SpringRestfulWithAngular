...
public class EmployeeServiceTest extends BaseTest {
    ...
    public void testGetByID() {
        ...
        Employee result = employeeService.getByID(9999);
    ...
    public void testGetAll() {
        ...
        expectedResult.add(emp);
        expectedResult.add(employeeService.getDummyEmployee());        
    ...
    public void testDelete() {
        ...
        Employee expectedResult = employeeService.getDummyEmployee();
        Employee result = employeeService.delete(9999);
